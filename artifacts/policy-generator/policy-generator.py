...
def create_safes_file(json_string):
    ...
    Leader/Follower that has all of these secrets. The onus is on the
    developer to append "/variable-X" to the safe identity at that time.
    """
...
def natural_sort_key(s):
    """
    Used to ensure that items are sorted naturally as opposed to alphabetical
    order.
    """
