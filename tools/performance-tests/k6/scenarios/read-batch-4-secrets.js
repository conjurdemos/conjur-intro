...
export default function () {
  ...
  const path = `/secrets?variable_ids=${conjurAccount}:variable:${identity}%2Fvariable-${(variableNumber)%5+1}${uuid_suffix},${conjurAccount}:variable:${identity}%2Fvariable-${(variableNumber+1)%5+1}${uuid_suffix},${conjurAccount}:variable:${identity}%2Fvariable-${(variableNumber+2)%5+1}${uuid_suffix},${conjurAccount}:variable:${identity}%2Fvariable-${(variableNumber+3)%5+1}${uuid_suffix}`
