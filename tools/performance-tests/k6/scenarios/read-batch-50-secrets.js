...
const readfiftySecretsBatchTrend = new Trend('http_req_duration_get_fifty_secrets_batch', true);
const readfiftySecretsBatchFailRate = new Rate('http_req_failed_get_fifty_secrets_batch');
