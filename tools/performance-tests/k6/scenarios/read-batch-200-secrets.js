...
export function handleSummary(data) {
  return {
    "./tools/performance-tests/k6/reports/read-batch-200-secrets-summary.html": htmlReport(data, {title: "Read Batch 200 Secrets " + new Date().toISOString().slice(0, 16).replace('T', ' ')}),
